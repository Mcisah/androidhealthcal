...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RaceName = extras.getString("RaceName");
    ...
    public void MailMessage(View button) {
        ...
        if (sweet >= 90) {
            Message = "The " +RaceName+ " " +Genders + " patient aged " +Age+ " years, and weighing " + Weights +" kg, with a serum creatinine value of " +crt +" mg/dl " +
...
//        }
        ...
        Intent intent = new Intent(Main4Activity.this, Mailer2.class);
